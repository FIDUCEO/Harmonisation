...
def multipH(filelist, notime, series):
    ...
    if notime: # work with no-time dependant dataset
...
if __name__ == "__main__":
    ...
    filelist = ["m02_n19.nc","m02_n15.nc","n15_n14.nc","n14_n12.nc","n12_n11.nc","n11_n10.nc","n10_n09.nc"] # temp solution
    ...
    sodr, Hd, Hr, Hs, mutime = multipH(filelist, notime, avhrrNx)
