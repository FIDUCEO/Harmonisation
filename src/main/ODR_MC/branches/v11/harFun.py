...
Not working, possibly the test on of series.notime. """
def fcnP(coef, data, series):
    a0 = coef[0] # AVHRR model coefficients
    a1 = coef[1]
    a2 = coef[2]
    
    # a3 calibration coefficient based on time / notime dataset
    if series.notime:
        a3 = 0 # meas. model sets a3*To to 0
    else:
        a3 = coef[3]    
    ...
    LE = MEfunc[series.slabel](CE,Cs,Cict,Lict,To,a0,a1,a2,a3)
