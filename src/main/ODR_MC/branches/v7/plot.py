...
class Plot:
    ...
    def plotLenU(self, inL, calL, ucLodr, ucLmc, ucdL, flab, idx=None):
        ...
        self.plot_scatter([inL[idx] for idx in self.selMU], 
                          ...
                          ttl='Radiance uncertainty from ODR fit coefficients, uncertainty evaluated by ODR', 
        ...
        self.plot_scatter([inL[idx] for idx in self.selMU], 
                          ...
                          ttl='Radiance uncertainty from ODR fit coefficients, uncertainty evaluated via MC', 
                          xlbl="Radiance (mW/m2/sr/cm-1)", 
