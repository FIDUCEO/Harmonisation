...
Arguments of the function:
    ...
    - sig: 
"""
def plotMCres(avhrrS,noMU,nobj,inC,slab,Hrnd,Hsys,odrSD,MCcov,sig):
    ...
    plot_ttl = slab + ' Radiance bias and ' + r'$sig*\sigma$'+ ' uncertainty from MC eval. of coeffs\' covariance'
    vis.LbiasU(inL[selMU], calL[selMU], mccLU[selMU], sig, plot_ttl) # from MC evaluation of uncertainty
    plot_ttl = slab + ' Radiance bias and ' + r'$sig*\sigma$'+ ' uncertainty from data and coeffs\' uncertainty (by MC)'
    vis.LbiasU(inL[selMU], calL[selMU], mcLU[selMU], sig, plot_ttl) # from MC evaluation of uncertainty
    plot_ttl = slab + ' Radiance uncertainty bias from coeffs\' uncertainty evaluated by MC and by ODR'
