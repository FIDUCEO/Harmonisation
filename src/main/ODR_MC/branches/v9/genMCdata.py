...
def genMCdata(fn,M,Xbe,Ybe,Hr,CsUr,CictUr,corIdx,cLen,beta0,series,Hs=None):
...
if __name__ == "__main__":
    ...
    if notime:
        genMCdata(tfn,nor,X.T,Y,Hr,csUr,cictUr,corIdx,cLen,bodr,avhrrNx)
    else:
        genMCdata(tfn,nor,X.T,Y,Hr,csUr,cictUr,corIdx,cLen,bodr,avhrrNx,Hs)
