...
def readMCdata(filename):     
    ...
    return X,Y,Ur,Us,corIdx,corLen,CsUr,CictUr,beta, notd
...
if __name__ == "__main__":
    ...
    X,Y,Hr,Hs,corIdx,corLen,CsUr,CictUr,bodr,notd = readMCdata(ncfile)     
    ...
    errStr = genErr(Hr, sLict, sTo, CsUr, CictUr, corIdx, corLen, notd)
    #errStr = mce.genErr(Hr, sLict, sTo, CsUr, CictUr, corIdx, corLen, notd)
