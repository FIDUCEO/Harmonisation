""" FIDUCEO FCDR harmonisation 
    Author: Arta Dilo and Peter Harris / NPL MM, Sam Hunt / NPL ECO
...
""" Peter & Sam's computation of weight matrix """
...
""" Generate the matrix of errors using Sam & Peter's W matrix """
def genErr(Hr, Lsys, Tsys, uCs, uCict, slTidx, clen, muCnt):
    ...
    Cs_err, Cs_raw = calc_CC_err(uCs, slTidx, clen)
    ...
    Cict_err, Cict_raw = calc_CC_err(uCict, slTidx, clen)
