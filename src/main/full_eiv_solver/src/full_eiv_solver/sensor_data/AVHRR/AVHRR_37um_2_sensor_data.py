"""
AVHRR 3.7um channel sensor data (time-independent model)
"""
...
'''___EIV Modules___'''
from AVHRR_sensor_models import sensor_model_37_2 as AVHRR_sensor_function
