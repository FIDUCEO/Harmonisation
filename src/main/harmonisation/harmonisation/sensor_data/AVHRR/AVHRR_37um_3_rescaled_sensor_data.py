"""
AVHRR 37um channel sensor data (time-dependent model, rescaled calibration parameters)
"""
...
from AVHRR_sensor_models import sensor_model_37_3_scaled as AVHRR_sensor_function
...
class AVHRR37um3Rescaled:
    def __init__(self):
        self.name = "AVHRR_37um_3_rescaled"
