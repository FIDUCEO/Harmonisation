...
def sensor_model_37_2(sensor_model_variables, sensor_model_parameter, sensor_model_constant, sensor_model_index):
    """
    :type sensor_model_variables: list:numpy.ndarray
    :param sensor_model_variables: list of sensor state variables
    ...
    # Evaluate radiance using sensor model
    Ja = vstack((ones(m), Rict * (Cs - Ce) / (Cs - Cict))).T
...
def sensor_model_37_3(sensor_model_variables, sensor_model_parameter, sensor_model_constant, sensor_model_index):
    """
    :type sensor_model_variables: list:numpy.ndarray
    :param sensor_model_variables: list of sensor state variables
...
def sensor_model_37_2_scaled(sensor_model_variables, sensor_model_parameter, sensor_model_constant, sensor_model_index):
    """
    :type sensor_model_variables: list:numpy.ndarray
    :param sensor_model_variables: list of sensor state variables
...
def sensor_model_37_3_scaled(sensor_model_variables, sensor_model_parameter, sensor_model_constant, sensor_model_index):
    """
    :type sensor_model_variables: list:numpy.ndarray
    :param sensor_model_variables: list of sensor state variables
