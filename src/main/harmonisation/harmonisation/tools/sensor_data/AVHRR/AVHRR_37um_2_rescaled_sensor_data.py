"""
AVHRR 3.7um channel sensor data (time-independent model, rescaled calibration parameters)
"""
...
'''___EIV Modules___'''
from AVHRR_sensor_models import sensor_model_37_2_scaled as AVHRR_sensor_function
...
class AVHRR37um2Rescaled:
    def __init__(self):
        self.name = "AVHRR_37um_2_rescaled"
