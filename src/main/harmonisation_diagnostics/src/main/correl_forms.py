...
class CorrelForm:
    ...
    def return_correlation(self, times, width, i_1, i_2):
        ...
        :param width: numpy.ndarray
            time width of averaging window corrData auxiliary data from file (this name)
        :param i_1: int
            index in times of central scanline of averaging
        :param i_2: int
            index in times of outer scanline of interest
